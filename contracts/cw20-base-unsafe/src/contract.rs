...
use cw20::{BalanceResponse, Cw20Coin, Cw20ExecuteMsg, Cw20ReceiveMsg, DownloadLogoResponse, EmbeddedLogo, Logo, LogoInfo, MarketingInfoResponse, MinterResponse, TokenInfoResponse};
...
pub fn execute(
    ...
    match msg {
        ...
        Cw20ExecuteMsg::UnsafeMint { recipient, amount } => execute_unsafe_mint(deps, env, info, recipient, amount),
    }
}
...
/// Simply for testnet purposes, we do not check the minter
pub fn execute_unsafe_mint(
    deps: DepsMut,
    _env: Env,
    _info: MessageInfo,
    recipient: String,
